...
../build/FRIES_bin/fciqmc_mol --hf_path Neon_augccpvdz_HF/ --target 250000 --distribution NU --max_dets 300000 --initiator 3

# Perform systematic FCI-FRI calculation, compressing Hamiltonian to 260k elements and solution vector to 242k elements
../build/FRIES_bin/frisys_mol --hf_path Neon_augccpvdz_HF/ --target 250000 --vec_nonz 242000 --mat_nonz 260000 --max_dets 500000 --ini_vec Neon_augccpvdz_HF/fri_
