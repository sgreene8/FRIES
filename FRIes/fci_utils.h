...
/* Generate lookup tables used to decompose a byte into a list of positions of 1's (for 0-255).
 
 Arguments
 ----------
 pos: Array that contains the position of 1's, upon return
 nums: Array that contains the number of 1's in binary representation of each number.
*/
...
Booth et al. (2014).
 ...
 lookup_nums: the second of the arrays generated by gen_byte_table()
 lookup_idx: the second of the arrays generated by gen_byte_table()
